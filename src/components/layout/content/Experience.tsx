                ...
                text-xs sm:text-sm md:text-base">
                    ...
                    <div>
                        <ul className="text-justify">
                            <li>GIS & Bản đồ: Tích hợp Leaflet.js để hiển thị bản đồ tương tác với các điểm đánh dấu có thể kéo thả, phục vụ theo dõi vị trí theo thời gian thực.</li>
                            <li>Dịch vụ định vị: Phát triển chức năng lấy tọa độ người dùng và xác nhận vị trí, sau đó lưu vào hệ thống phục vụ đăng ký hộ kinh doanh.</li>
                            <li>Xử lý hình ảnh: Xây dựng tính năng chụp ảnh trực tiếp hoặc tải lên từ thiết bị, cho phép người dùng đính kèm hình ảnh.</li>
                            <li>API vị trí động: Tích hợp .NET Web API để lấy và cập nhật dữ liệu tỉnh/thành, quận/huyện và phường/xã một cách linh hoạt.</li>
                            <li>Trực quan hóa dữ liệu: Xây dựng bảng thống kê hiển thị tình trạng thu thập dữ liệu hộ kinh doanh.</li>
                            <li>Quản lý cơ sở dữ liệu: Kết nối .NET Web API với PostgreSQL để truy xuất và lưu trữ dữ liệu mượt mà.</li>
                           <li> Kiểm thử & xác thực API: Sử dụng Postman để kiểm thử và xác thực các yêu cầu API.</li>
                        </ul>
                    </div>
